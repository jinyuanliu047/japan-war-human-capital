...
di "=== Dummy Baseline ==="
reghdfejl eduy i.d_count_high##ib0.post1940 ln_cohort_n minority i.wave if !drop1939, ///
    absorb(county_num birth_i) vce(cluster county_num)
...
foreach ctrl of local controls {
    local col = `col' + 1
    di "=== Dummy + `ctrl' ==="
    reghdfejl eduy i.d_count_high##ib0.post1940 c.`ctrl'##ib0.post1940 ln_cohort_n minority i.wave if !drop1939, ///
        absorb(county_num birth_i) vce(cluster county_num)
...
di "=== Dummy + All five ==="
reghdfejl eduy i.d_count_high##ib0.post1940 ///
    c.sdy_density##ib0.post1940 c.ins_famine##ib0.post1940 ///
    c.ln_victims_cr##ib0.post1940 c.ln_grain_output##ib0.post1940 ///
...
tempname fh
file open `fh' using "${outdir}/pooled_historical_controls_expanded_v1.tex", write replace
file write `fh' "{" _n
...
reghdfejl eduy c.ihs_rate##ib0.post1940 c.ihs_longmarch##ib0.post1940 minority i.wave if !drop1939, ///
    absorb(county_num birth_i) vce(cluster county_num)
...
/* (3) IHS + Korea (IHS) */
reghdfejl eduy c.ihs_rate##ib0.post1940 c.ihs_korea##ib0.post1940 minority i.wave if !drop1939, ///
    absorb(county_num birth_i) vce(cluster county_num)
...
/* (4) IHS + Both */
reghdfejl eduy c.ihs_rate##ib0.post1940 c.ihs_longmarch##ib0.post1940 ///
...
/* (6) Dummy + Long March */
reghdfejl eduy i.d_count_high##ib0.post1940 c.ihs_longmarch##ib0.post1940 ln_cohort_n minority i.wave if !drop1939, ///
    absorb(county_num birth_i) vce(cluster county_num)
...
/* (7) Dummy + Korea */
reghdfejl eduy i.d_count_high##ib0.post1940 c.ihs_korea##ib0.post1940 ln_cohort_n minority i.wave if !drop1939, ///
    absorb(county_num birth_i) vce(cluster county_num)
...
/* (8) Dummy + Both */
reghdfejl eduy i.d_count_high##ib0.post1940 c.ihs_longmarch##ib0.post1940 ///
...
tempname fh
file open `fh' using "${outdir}/pooled_longmarch_korea_expanded_v1.tex", write replace
file write `fh' "{" _n
file write `fh' "\def\sym#1{\ifmmode^{#1}\else\(\sp{#1}\)\fi}" _n
