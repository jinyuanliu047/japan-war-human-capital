...
* Correct historical panels with pre-1940 cohorts
...
tempname memhold
postfile `memhold' str4 wave double b se p N r2 ar2 using "${proj}/result/table/main_eduy_mean_cutoff1940_baseline_v2_tmp.dta", replace
...
esttab model1982 model1990 model2000 using "${proj}/result/table/main_eduy_mean_cutoff1940_baseline_v2.tex", ///
...
postclose `memhold'
use "${proj}/result/table/main_eduy_mean_cutoff1940_baseline_v2_tmp.dta", clear
export delimited using "${proj}/result/table/main_eduy_mean_cutoff1940_baseline_v2.csv", replace
erase "${proj}/result/table/main_eduy_mean_cutoff1940_baseline_v2_tmp.dta"
