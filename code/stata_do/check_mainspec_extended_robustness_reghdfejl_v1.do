*******************************************************
* Main-spec robustness (same FE as baseline main table)
* Baseline FE: county FE + birth-year FE
* Estimator: reghdfejl
*******************************************************
...
capture program drop _run_wave_mainspec
program define _run_wave_mainspec, rclass
...
foreach w in 1982 1990 2000 {
    ...
    quietly _run_wave_mainspec, wave(`w') hi(`hi')
...
gen t_abs = abs(b/se)
gsort wave -t_abs
export delimited using "${proj}/result/table/mainspec_extended_robustness_reghdfejl_summary_v1.csv", replace
save "${proj}/result/table/mainspec_extended_robustness_reghdfejl_summary_v1.dta", replace

esttab ms1982_s1 ms1982_s2 ms1982_s3 ms1982_s4 ///
       ms1990_s1 ms1990_s2 ms1990_s3 ms1990_s4 ///
       ms2000_s1 ms2000_s2 ms2000_s3 ms2000_s4 ///
       using "${proj}/result/table/mainspec_extended_robustness_reghdfejl_v1.rtf", ///
       replace ///
       keep(1.post#c.ln_martyr_per100k_1953) ///
       scalar(AER_Post Conflict_Post County_FE Cohort_FE N_counties) ///
       se r2 ar2 ///
       star(* 0.1 ** 0.05 *** 0.01)
...
esttab ms1982_s1 ms1982_s2 ms1982_s3 ms1982_s4 ///
       ms1990_s1 ms1990_s2 ms1990_s3 ms1990_s4 ///
       ms2000_s1 ms2000_s2 ms2000_s3 ms2000_s4 ///
       using "${proj}/result/table/mainspec_extended_robustness_reghdfejl_v1.tex", ///
       replace ///
       keep(1.post#c.ln_martyr_per100k_1953) ///
       scalar(AER_Post Conflict_Post County_FE Cohort_FE N_counties) ///
       se r2 ar2 ///
