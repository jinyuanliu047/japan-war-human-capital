...
args wave outcsv
if "`wave'"=="" local wave "1982"
if "`outcsv'"=="" local outcsv "main_individual_longmarch_korea_`wave'_v1.csv"
...
tempfile summary
postfile sumhold str4 wave str12 spec double b se p n_obs using `summary', replace
...
reghdfe eduy c.ln_martyr_per100k_1953##ib0.post $control ///
...
quietly _grab
post sumhold ("`wave'") ("base") (r(b)) (r(se)) (r(p)) (e(N))
...
quietly _grab
post sumhold ("`wave'") ("longmarch") (r(b)) (r(se)) (r(p)) (e(N))
...
quietly _grab
post sumhold ("`wave'") ("korea") (r(b)) (r(se)) (r(p)) (e(N))
...
reghdfe eduy c.ln_martyr_per100k_1953##ib0.post $control ///
    ...
    absorb(county_num birth_i) vce(cluster county_num)
quietly _grab
post sumhold ("`wave'") ("both") (r(b)) (r(se)) (r(p)) (e(N))

postclose sumhold
use `summary', clear
export delimited using "${proj}/result/table/`outcsv'", replace
