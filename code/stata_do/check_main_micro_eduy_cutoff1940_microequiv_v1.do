...
_run_wave, wave(1982) panel("${proj}/data/temp/micro_equiv_panel_1982_v1.csv") lo(1920) hi(1960) dropyear(1939) basemodel(model1) fullmodel(model2) treatfile("`treat'") histfile("`histctrl'")
_run_wave, wave(1990) panel("${proj}/data/temp/micro_equiv_panel_1990_v1.csv") lo(1920) hi(1968) dropyear(1939) basemodel(model3) fullmodel(model4) treatfile("`treat'") histfile("`histctrl'")
_run_wave, wave(2000) panel("${proj}/data/temp/micro_equiv_panel_2000_v1.csv") lo(1920) hi(1978) dropyear(1939) basemodel(model5) fullmodel(model6) treatfile("`treat'") histfile("`histctrl'")

esttab model1 model2 model3 model4 model5 model6 using "${proj}/result/table/main_micro_eduy_cutoff1940_microequiv_v1.rtf", ///
    ...
    stats(Controls Hist_Control County_FE Cohort_FE Weight Cutoff N r2 ar2, labels("Individual controls" "County history control" "County FE" "Cohort FE" "Weights" "Treatment start" "Observations" "R-squared" "Adj. R-squared")) ///
    se star(* 0.1 ** 0.05 *** 0.01)

esttab model1 model2 model3 model4 model5 model6 using "${proj}/result/table/main_micro_eduy_cutoff1940_microequiv_v1.tex", ///
...
tempname memhold
postfile `memhold' str4 wave str12 spec double b se p N using "${proj}/result/table/main_micro_eduy_cutoff1940_microequiv_v1_tmp.dta", replace
...
postclose `memhold'
use "${proj}/result/table/main_micro_eduy_cutoff1940_microequiv_v1_tmp.dta", clear
export delimited using "${proj}/result/table/main_micro_eduy_cutoff1940_microequiv_v1.csv", replace
erase "${proj}/result/table/main_micro_eduy_cutoff1940_microequiv_v1_tmp.dta"
exit, clear
