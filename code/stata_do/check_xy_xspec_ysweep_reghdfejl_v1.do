*******************************************************
* X-measurement x Y-outcome sweep (reghdfejl)
* Y: eduy_mean / pri_comp / mid_comp / high_comp / college_comp
* X: ln_per100k / ihs_per100k / raw_count / ln_raw / share_winsor / ihs_share
* Spec: weighted baseline / weighted full controls
*******************************************************
...
foreach w in 1982 1990 2000 {
    ...
    foreach y in eduy_mean pri_comp mid_comp high_comp college_comp {
...
export delimited using "${proj}/result/table/xy_xspec_ysweep_reghdfejl_summary_v1.csv", replace
save "${proj}/result/table/xy_xspec_ysweep_reghdfejl_summary_v1.dta", replace
