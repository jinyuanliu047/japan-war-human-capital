*******************************************************
* Triple difference: ln_martyr x post x ln_heritage_site_count
*******************************************************
...
keep countyid_curr6 ln_heritage_site_count sdy_density ins_famine victims_cr grain_output urbanratio64 ///
...
replace ln_heritage_site_count = 0 if missing(ln_heritage_site_count)
...
program define _run_wave, rclass
    ...
    foreach v in ln_heritage_site_count sdy_density ins_famine victims_cr grain_output urbanratio64 ///
        ln_clan qk_cnt_m45_pre1940 qk_maxmag_pre1940 massacre_event_w ln_massacre_death {
    ...
    reghdfejl eduy_mean c.ln_heritage_site_count##ib0.post##c.ln_martyr_per100k_1953, ///
        absorb(county_num prov_cohort c.base_edu_pre#i.birth_i) vce(cluster county_num)
    estimates store hcnt`wave'_s1
    ...
    return scalar b1 = _b[1.post#c.ln_heritage_site_count#c.ln_martyr_per100k_1953]
    return scalar se1 = _se[1.post#c.ln_heritage_site_count#c.ln_martyr_per100k_1953]
    return scalar p1 = 2*ttail(e(df_r), abs(_b[1.post#c.ln_heritage_site_count#c.ln_martyr_per100k_1953]/_se[1.post#c.ln_heritage_site_count#c.ln_martyr_per100k_1953]))
    ...
    reghdfejl eduy_mean c.ln_heritage_site_count##ib0.post##c.ln_martyr_per100k_1953 ///
        ...
        absorb(county_num prov_cohort c.base_edu_pre#i.birth_i) vce(cluster county_num)
    estimates store hcnt`wave'_s2
    estadd local FullControls "Y"
    estadd local County_FE "Y"
    estadd local ProvCohort_FE "Y"
    estadd local BaseEduCohort "Y"
    estadd scalar N_counties = `n_counties'
    return scalar b2 = _b[1.post#c.ln_heritage_site_count#c.ln_martyr_per100k_1953]
    return scalar se2 = _se[1.post#c.ln_heritage_site_count#c.ln_martyr_per100k_1953]
    return scalar p2 = 2*ttail(e(df_r), abs(_b[1.post#c.ln_heritage_site_count#c.ln_martyr_per100k_1953]/_se[1.post#c.ln_heritage_site_count#c.ln_martyr_per100k_1953]))
end
...
gen t_abs = abs(b/se)
sort wave spec
export delimited using "${proj}/result/table/main_heritage_count_triple_diff_reghdfejl_summary_v1.csv", replace
save "${proj}/result/table/main_heritage_count_triple_diff_reghdfejl_summary_v1.dta", replace

esttab hcnt1982_s1 hcnt1982_s2 hcnt1990_s1 hcnt1990_s2 hcnt2000_s1 hcnt2000_s2 ///
    using "${proj}/result/table/main_heritage_count_triple_diff_reghdfejl_v1.rtf", ///
    replace ///
    keep(1.post#c.ln_martyr_per100k_1953 1.post#c.ln_heritage_site_count#c.ln_martyr_per100k_1953) ///
    scalar(FullControls County_FE ProvCohort_FE BaseEduCohort N_counties) ///
    se r2 ar2 ///
    star(* 0.1 ** 0.05 *** 0.01)

esttab hcnt1982_s1 hcnt1982_s2 hcnt1990_s1 hcnt1990_s2 hcnt2000_s1 hcnt2000_s2 ///
    using "${proj}/result/table/main_heritage_count_triple_diff_reghdfejl_v1.tex", ///
    replace ///
    keep(1.post#c.ln_martyr_per100k_1953 1.post#c.ln_heritage_site_count#c.ln_martyr_per100k_1953) ///
    scalar(FullControls County_FE ProvCohort_FE BaseEduCohort N_counties) ///
    se r2 ar2 ///
