*******************************************************
* Extended robustness (reghdfe fast)
*******************************************************
...
capture program drop _run_wave_hdf
program define _run_wave_hdf, rclass
...
foreach w in 1982 1990 2000 {
    ...
    quietly _run_wave_hdf, wave(`w') hi(`hi')
...
gen t_abs = abs(b/se)
gsort wave -t_abs
export delimited using "${proj}/result/table/main_extended_robustness_reghdfe_summary_v3.csv", replace
save "${proj}/result/table/main_extended_robustness_reghdfe_summary_v3.dta", replace

esttab hd1982_s1 hd1982_s2 hd1982_s3 hd1982_s4 ///
       hd1990_s1 hd1990_s2 hd1990_s3 hd1990_s4 ///
       hd2000_s1 hd2000_s2 hd2000_s3 hd2000_s4 ///
       using "${proj}/result/table/main_extended_robustness_reghdfe_v3.rtf", ///
       replace ///
...
esttab hd1982_s1 hd1982_s2 hd1982_s3 hd1982_s4 ///
       hd1990_s1 hd1990_s2 hd1990_s3 hd1990_s4 ///
       hd2000_s1 hd2000_s2 hd2000_s3 hd2000_s4 ///
       using "${proj}/result/table/main_extended_robustness_reghdfe_v3.tex", ///
       replace ///
       keep(1.post#c.ln_martyr_per100k_1953) ///
       scalar(AER_Post Conflict_Post County_FE ProvCohort_FE BaseEduCohort N_counties) ///
       se r2 ar2 ///
