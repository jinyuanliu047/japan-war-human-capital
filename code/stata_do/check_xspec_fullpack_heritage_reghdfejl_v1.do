...
*   B) Heterogeneity: heritage_any=0/1
...
export delimited using "${proj}/result/table/xspec_fullpack_heritage_reghdfejl_summary_v1.csv", replace
save "${proj}/result/table/xspec_fullpack_heritage_reghdfejl_summary_v1.dta", replace
