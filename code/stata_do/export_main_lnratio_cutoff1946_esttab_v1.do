*******************************************************
* Re-estimate main DID (ln ratio) and export esttab RTF
*******************************************************
...
foreach w in 1982 1990 2000 {
    ...
    estadd local drop1945 "Yes"
    estadd scalar n_cells = `n_cells'
    estadd scalar n_counties = `n_counties'
}

esttab m1982 m1990 m2000 using "${proj}/result/table/main_regression_lnratio_cutoff1946_esttab_v1.rtf", replace ///
    ...
    stats(county_fe cohort_fe se_cluster drop1945 n_cells n_counties N r2_a, ///
          labels("County FE" "Birth-year FE" "SE cluster" "Drop 1945 cohort" "Cell observations" "Counties" "N (estimation)" "Adj. R2"))
