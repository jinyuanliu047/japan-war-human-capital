...
program define _one_wave, rclass
    ...
    use "`coef'", clear
    sort birthyr
    export delimited using "${proj}/data/temp/eventstudy_coefficient_base1931_start1940_`wave'_v1.csv", replace
    save "${proj}/data/temp/eventstudy_coefficient_base1931_start1940_`wave'_v1.dta", replace
end
...
foreach w in 1982 1990 2000 {
    ...
    post `posth' ("`w'") (1940) (1931) (1920) (`hi') ///
...
use "`out'", clear
sort wave
export delimited using "${proj}/data/temp/eventstudy_coefficient_base1931_start1940_wavecut_summary_v1.csv", replace
save "${proj}/data/temp/eventstudy_coefficient_base1931_start1940_wavecut_summary_v1.dta", replace
list, clean noobs
