...
program define _one_wave, rclass
    ...
    quietly areg eduy_mean c.ln_martyr_per100k_1953##ib1939.birth_i i.birth_i, ///
        absorb(county_num) vce(cluster county_num)
    ...
    use "`coef'", clear
    sort birthyr
    export delimited using "${proj}/data/temp/eventstudy_coefficient_base1939_start1940_`wave'_v1.csv", replace
    save "${proj}/data/temp/eventstudy_coefficient_base1939_start1940_`wave'_v1.dta", replace
end

tempname posth
tempfile out
postfile `posth' str6 wave int startyr baseyr sample_lo sample_hi ///
    double b_did se_did p_did p_pre_equalbase p_post_equalbase ///
...
foreach w in 1982 1990 2000 {
    ...
    post `posth' ("`w'") (1940) (1939) (1920) (`hi') ///
        (r(b_did)) (r(se_did)) (r(p_did)) (r(p_pre_equalbase)) (r(p_post_equalbase)) ///
...
use "`out'", clear
sort wave
export delimited using "${proj}/data/temp/eventstudy_coefficient_base1939_start1940_wavecut_summary_v1.csv", replace
save "${proj}/data/temp/eventstudy_coefficient_base1939_start1940_wavecut_summary_v1.dta", replace
list, clean noobs
