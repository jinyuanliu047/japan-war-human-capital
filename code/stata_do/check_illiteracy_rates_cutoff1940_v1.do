...
tempname memhold
postfile `memhold' int wave double b se p N r2 ar2 using "${proj}/result/table/illiteracy_rates_cutoff1940_summary_v1.dta", replace
...
postclose `memhold'
use "${proj}/result/table/illiteracy_rates_cutoff1940_summary_v1.dta", clear
export delimited using "${proj}/result/table/illiteracy_rates_cutoff1940_summary_v1.csv", replace
