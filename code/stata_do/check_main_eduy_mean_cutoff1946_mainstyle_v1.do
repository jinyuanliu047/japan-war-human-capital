...
esttab model1 model2 model3 model4 model5 model6 using "${proj}/result/table/main_eduy_mean_cutoff1946_mainstyle_v1.rtf", ///
    replace ///
...
esttab model1 model2 model3 model4 model5 model6 using "${proj}/result/table/main_eduy_mean_cutoff1946_mainstyle_v1.tex", ///
    replace ///
    booktabs ///
    nonotes ///
    keep(1.post#c.ln_martyr_per100k_1953) ///
...
tempname memhold
postfile `memhold' str4 wave str12 spec double b se p N using "${proj}/result/table/main_eduy_mean_cutoff1946_mainstyle_v1_tmp.dta", replace
...
postclose `memhold'
use "${proj}/result/table/main_eduy_mean_cutoff1946_mainstyle_v1_tmp.dta", clear
export delimited using "${proj}/result/table/main_eduy_mean_cutoff1946_mainstyle_v1.csv", replace
erase "${proj}/result/table/main_eduy_mean_cutoff1946_mainstyle_v1_tmp.dta"
exit, clear
