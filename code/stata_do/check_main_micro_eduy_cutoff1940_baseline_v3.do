...
* Export
*******************************************************
esttab m1982 m1990 m2000 using "${proj}/result/table/main_micro_eduy_cutoff1940_baseline_v3.rtf", ///
    replace ///
...
esttab m1982 m1990 m2000 using "${proj}/result/table/main_micro_eduy_cutoff1940_baseline_v3.tex", ///
...
tempname memhold
postfile `memhold' str4 wave double b se p N N_counties using "${proj}/result/table/main_micro_eduy_cutoff1940_baseline_v3_tmp.dta", replace
...
postclose `memhold'
use "${proj}/result/table/main_micro_eduy_cutoff1940_baseline_v3_tmp.dta", clear
export delimited using "${proj}/result/table/main_micro_eduy_cutoff1940_baseline_v3.csv", replace
erase "${proj}/result/table/main_micro_eduy_cutoff1940_baseline_v3_tmp.dta"
