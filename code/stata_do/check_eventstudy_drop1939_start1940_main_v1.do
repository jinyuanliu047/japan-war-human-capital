*******************************************************
* Event-study check: drop 1939, treated cohorts >=1940
* Waves: 1982 / 1990 / 2000
* Sample window: 1931-1960, excluding 1939
* Base cohort in ES: 1938 (last kept pre cohort)
*******************************************************
...
program define _one_run, rclass
    ...
    * base cohort = 1938 => rel = -2 => idx = 48
    ...
    foreach k of local levels {
        local yy = 1940 + `k'
        if `k' == -2 {
            post `ph' ("`wave'") (`yy') (`k') (0) (0) (0) (0) (1940) (1938) (1931) (1960)
        }
        else {
            local kk = `k' + 50
    ...
    use "`coef'", clear
    sort birthyr
    export delimited using "${proj}/data/temp/eventstudy_coef_drop1939_start1940_main_`wave'_v1.csv", replace
    save "${proj}/data/temp/eventstudy_coef_drop1939_start1940_main_`wave'_v1.dta", replace
end
...
foreach w in 1982 1990 2000 {
    ...
    post `posth' ("`w'") (1940) (1938) (1931) (1960) ///
...
use "`out'", clear
sort wave
export delimited using "${proj}/data/temp/eventstudy_drop1939_start1940_main_summary_v1.csv", replace
save "${proj}/data/temp/eventstudy_drop1939_start1940_main_summary_v1.dta", replace
list, clean noobs
