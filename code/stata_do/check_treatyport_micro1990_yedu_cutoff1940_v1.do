...
esttab model1 model2 using "${proj}/result/table/treatyport_micro1990_yedu_cutoff1940_v1.tex", ///
    replace ///
    booktabs ///
    nonotes ///
...
tempname memhold
postfile `memhold' str12 subgroup double b se p n_obs n_counties using "${proj}/result/table/treatyport_micro1990_yedu_cutoff1940_summary_v1_tmp.dta", replace
...
use "${proj}/result/table/treatyport_micro1990_yedu_cutoff1940_summary_v1_tmp.dta", clear
export delimited using "${proj}/result/table/treatyport_micro1990_yedu_cutoff1940_summary_v1.csv", replace
save "${proj}/result/table/treatyport_micro1990_yedu_cutoff1940_summary_v1.dta", replace
