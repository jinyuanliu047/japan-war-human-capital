*******************************************************
* Heterogeneity: explicit locations named on the Wiki link
*******************************************************
...
use `summary', clear
export delimited using "${proj}/result/table/main_antijap_base_link_heterogeneity_reghdfejl_summary_v2.csv", replace
save "${proj}/result/table/main_antijap_base_link_heterogeneity_reghdfejl_summary_v2.dta", replace

esttab `models' using "${proj}/result/table/main_antijap_base_link_heterogeneity_reghdfejl_v2.rtf", ///
    replace keep(1.post#c.ln_martyr_per100k_1953) scalar(BaseLink N_sample) se r2 ar2 star(* 0.1 ** 0.05 *** 0.01)

esttab `models' using "${proj}/result/table/main_antijap_base_link_heterogeneity_reghdfejl_v2.tex", ///
    replace keep(1.post#c.ln_martyr_per100k_1953) scalar(BaseLink N_sample) se r2 ar2 star(* 0.1 ** 0.05 *** 0.01)
