*******************************************************
* Individual-level heterogeneity (reghdfejl)
...
foreach w in 1982 1990 2000 {
    ...
    quietly reghdfejl eduy c.ln_martyr_per100k_1953##ib0.post $control if female==0, ///
    ...
    quietly _prep_wave_data, wave(`w') hi(`hi')
    quietly reghdfejl eduy c.ln_martyr_per100k_1953##ib0.post $control if female==1, ///
        absorb(county_num birth_i) vce(cluster county_num)
...
use `gsum', clear
export delimited using "${proj}/result/table/main_individual_heterogeneity_gender_reghdfejl_summary_v2.csv", replace
save "${proj}/result/table/main_individual_heterogeneity_gender_reghdfejl_summary_v2.dta", replace

esttab g1982_male g1982_female g1990_male g1990_female g2000_male g2000_female ///
    using "${proj}/result/table/main_individual_heterogeneity_gender_reghdfejl_v2.rtf", ///
    replace ///
...
esttab g1982_male g1982_female g1990_male g1990_female g2000_male g2000_female ///
    using "${proj}/result/table/main_individual_heterogeneity_gender_reghdfejl_v2.tex", ///
    replace ///
    keep(1.post#c.ln_martyr_per100k_1953) ///
    scalar(Group Controls County_FE Cohort_FE) ///
    se r2 ar2 ///
...
foreach w in 1990 2000 {
    ...
    quietly _prep_wave_data, wave(`w') hi(`hi')
    quietly reghdfejl eduy c.ln_martyr_per100k_1953##ib0.post minority if urban_tag==1, ///
        absorb(county_num birth_i) vce(cluster county_num)
    ...
    quietly _prep_wave_data, wave(`w') hi(`hi')
    quietly reghdfejl eduy c.ln_martyr_per100k_1953##ib0.post minority if rural_tag==1, ///
        absorb(county_num birth_i) vce(cluster county_num)
...
use `usum', clear
export delimited using "${proj}/result/table/main_individual_heterogeneity_urbanrural_reghdfejl_summary_v2.csv", replace
save "${proj}/result/table/main_individual_heterogeneity_urbanrural_reghdfejl_summary_v2.dta", replace

esttab u1990_urban u1990_rural u2000_urban u2000_rural ///
    using "${proj}/result/table/main_individual_heterogeneity_urbanrural_reghdfejl_v2.rtf", ///
    replace ///
    keep(1.post#c.ln_martyr_per100k_1953) ///
    scalar(Group Controls County_FE Cohort_FE) ///
    se r2 ar2 ///
...
esttab u1990_urban u1990_rural u2000_urban u2000_rural ///
    using "${proj}/result/table/main_individual_heterogeneity_urbanrural_reghdfejl_v2.tex", ///
    replace ///
    keep(1.post#c.ln_martyr_per100k_1953) ///
    scalar(Group Controls County_FE Cohort_FE) ///
    se r2 ar2 ///
