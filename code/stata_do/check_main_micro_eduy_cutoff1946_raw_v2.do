...
esttab model1 model2 model3 using "${proj}/result/table/main_micro_eduy_cutoff1946_raw_v2.rtf", ///
    replace ///
...
esttab model1 model2 model3 using "${proj}/result/table/main_micro_eduy_cutoff1946_raw_v2.tex", ///
    replace ///
    booktabs nonotes ///
    keep(1.post#c.ln_martyr_per100k_1953) ///
    coeflabels(1.post#c.ln_martyr_per100k_1953 "Post × War exposure") ///
...
postclose sumhold
use `summary', clear
export delimited using "${proj}/result/table/main_micro_eduy_cutoff1946_raw_v2.csv", replace
