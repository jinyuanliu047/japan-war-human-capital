...
foreach cutoff in 1940 1946 {
    ...
    ppmlhdfe eduy i.d_count_high##ib0.post minority i.wave if !drop_yr, ///
    ...
    ppmlhdfe eduy i.d_count_high##ib0.post minority i.wave if !drop_yr & female==0, ///
        absorb(county_num birth_i) vce(cluster county_num)
    local b  = _b[1.d_count_high#1.post]
    local se = _se[1.d_count_high#1.post]
    local p  = 2*ttail(e(df_r), abs(`b'/`se'))
    ...
    ppmlhdfe eduy i.d_count_high##ib0.post minority i.wave if !drop_yr & female==1, ///
        absorb(county_num birth_i) vce(cluster county_num)
    local b  = _b[1.d_count_high#1.post]
    local se = _se[1.d_count_high#1.post]
    local p  = 2*ttail(e(df_r), abs(`b'/`se'))
    ...
    ppmlhdfe eduy i.d_count_high##ib0.post minority i.wave if !drop_yr & high_base_edu==0, ///
        absorb(county_num birth_i) vce(cluster county_num)
    local b  = _b[1.d_count_high#1.post]
    local se = _se[1.d_count_high#1.post]
    local p  = 2*ttail(e(df_r), abs(`b'/`se'))
    ...
    ppmlhdfe eduy i.d_count_high##ib0.post minority i.wave if !drop_yr & high_base_edu==1, ///
        absorb(county_num birth_i) vce(cluster county_num)
    local b  = _b[1.d_count_high#1.post]
    local se = _se[1.d_count_high#1.post]
    local p  = 2*ttail(e(df_r), abs(`b'/`se'))
    ...
    ppmlhdfe eduy i.d_count_high##ib0.post i.wave if !drop_yr & minority==0, ///
        absorb(county_num birth_i) vce(cluster county_num)
    local b  = _b[1.d_count_high#1.post]
    local se = _se[1.d_count_high#1.post]
    local p  = 2*ttail(e(df_r), abs(`b'/`se'))
    ...
    ppmlhdfe eduy i.d_count_high##ib0.post i.wave if !drop_yr & minority==1, ///
        absorb(county_num birth_i) vce(cluster county_num)
    local b  = _b[1.d_count_high#1.post]
    local se = _se[1.d_count_high#1.post]
    local p  = 2*ttail(e(df_r), abs(`b'/`se'))
